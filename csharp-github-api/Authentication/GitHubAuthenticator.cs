...
namespace csharp_github_api.Authentication
{
    ...
    public class GitHubOAuthAuthenticator : IAuthenticator
    {
        ...
        /// <summary>
        /// Instantiates a new instance of the <see cref="GitHubOAuthAuthenticator"/> class.
        /// </summary>
        ...
        public GitHubOAuthAuthenticator(string username, string password, bool useApiKey)
        {
            _username = username;
            _password = password;
